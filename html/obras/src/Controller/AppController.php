...
class AppController extends Controller
{
    ...
    public function beforeFilter(Event $event)
    {
        ...
        $this->set('isIns', $this->_isInspector());
        $this->set('nifC', $this->_nifConstructor());
    }
    /**
    ...
    function _nifConstructor()
    {
        $nifC = "";
        // Admin can access every action
        if ($this->Auth->user('tipo') == "cons") {
            $nifC = $this->Auth->user('NIF');
        }
        return $nifC;
    }

    function _isInspector()
    {
        $isIns = false;
        // Admin can access every action
        if ($this->Auth->user('tipo') == "inspector") {
            $isIns = true;
        }
        return $isIns;
    }
